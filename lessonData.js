module.exports = {
  CR21a: {
    ...
    learn: {
      media1: 'https://www.youtube.com/embed/ZEWitdYB6_Y?rel=0&amp;showinfo=0',
      media2: 'https://www.youtube.com/embed/w33-m8-geuM?rel=0&amp;showinfo=0'
    },
    practice: {
      media: 'https://www.youtube.com/embed/vbuq7w3ZDUQ?rel=0&amp;showinfo=0',
      directions: 'Watch the video, then answer the questions.',
      question1: 'What happened in the beginning of the story?',
      subQuestion1: '(Remember to use either "first", "next", "then", "after that", or "finally" in your answer.)',
      question2: 'What happened in the middle of the story?',
      subQuestion2: '(Remember to use either "first", "next", "then", "after that", or "finally" in your answer.)',
  ...
  CR22a: {
    ...
    skillDescription: '1. Characters: Who is in the story \n 2. Setting: Where the story happens \n 3. Problem: Something in the story that needs to be fixed \n 4. Solution: How the problem gets fixed \n 5. Events: Things that happen in the story',
    learn: {
      media1: 'https://www.youtube.com/embed/NxiiOXycvlI?rel=0&amp;showinfo=0&amp;start=7',
      media2: 'https://www.youtube.com/embed/hqEqT7wG9zA?rel=0&amp;showinfo=0&amp;start=10'
    },
    practice: {
      media: 'https://www.youtube.com/embed/2GCzyZexnNE?rel=0&amp;showinfo=0',
      directions: 'Watch the video, then answer the questions.',
      question1: 'Remember, a setting is where the story happens.',
      subQuestion1: 'What is the setting of this story? How do you know?',
      question2: 'Remember, characters are people or animals in the story.',
      subQuestion2: 'Who are the characters in this story?',
    ...
    bookCovers: [
      ...
      activity: {
        ...
        heading3: 'Problem',
        heading4: 'Solution',
        subheading1: 'Reason #1',
        subheading2: 'Reason #2'
      },
    lessonComplete: ['Be proud of yourself! You accomplished something great today!', 'https://giphy.com/embed/jbtCu5ScXS2He']
  },
  CR23a: {
    lessonTitle: 'Character\'s Response to Events',
    skillDescription: 'A character\'s response is how a character feels or what they do when something happens in the story.',
    learn: {
      media1: 'https://giphy.com/embed/3oEhmKV4lJzCspvw9W',
      media2: 'https://www.youtube.com/embed/Iekv6R9U1dM?rel=0&amp;showinfo=0'
    },
    practice: {
      media: 'https://www.youtube.com/embed/MZ2tq0F8-ww?rel=0&amp;showinfo=0',
      directions: 'Watch the video, then answer the questions.',
      question1: 'How does the first bird respond when they other birds land near it?',
      subQuestion1: 'How do you know?',
      question2: 'How do the small birds respond when they see the large bird?',
      subQuestion2: 'How do you know?',
  ...
  CR24a: {
    lessonTitle: 'Main Topic in an Informational Text',
    skillDescription: 'An informational text is one that teaches us true things and a main topic is what the text is all about.',
    learn: {
      media1: 'https://www.youtube.com/embed/-o_lA7oSSWs?rel=0&amp;showinfo=0&amp;start=8',
      media2: 'https://www.youtube.com/embed/C1W46goOpu0?rel=0&amp;showinfo=0'
    },
    practice: {
      media: 'https://www.youtube.com/embed/3pi6acgWOdk?rel=0&amp;showinfo=0',
      directions: 'Watch the video, then answer the questions.',
      question1: 'Is this video informational?',
      subQuestion1: 'How do you know?',
      question2: 'What do you think is the main topic of this video?',
      subQuestion2: '',
  ...
  CR25a: {
    lessonTitle: 'Informational Text Features',
    skillDescription: 'Important informational text features are headings (the title of a chapter or section), captions (text near the picture that tells you more about the picture), and pictures.',
    learn: {
      media1: 'https://www.youtube.com/embed/3mAl9QMJJTo?rel=0&amp;showinfo=0',
      media2: 'https://giphy.com/embed/l44Q9EPJIzYediXp6'
    },
    practice: {
      media: 'https://lh3.googleusercontent.com/E25-UQ9Wm7HEoFu9zE8Y5dJKxzIAF0Ve-2-YtU5a9ie911V4n_1R8NBWnceIHaHkK54RGJo9480PK9CsEpooHoRlWo6eD1pmuQibgHJJF9nDl8C6G2jlRdNLhI3rYXazkU0DPY2GX86vnwjC5gHz0RwCZssDoEB8qckeukSzudJKlNyrJjT2FQSrFCpWy8-xQT_8_zKcglzxBzSQdWAzGMh1Tsvyj7NjebGFSXGyitWauywMwzjFHInFeqGKGM-T4fJ6hNWMkyrb4ru9URV0eJt4rm0jaDF_xaJXtWfvBmw-GuBdAn-sbqgDTgPR4z9xCX-gM83084QFHwjp8HmtiyywDsMoelwcmdvQWjaJbHzUHo7VPUOV6ifl4Ug-R1L9y_vNGLTXQK-QSD8avbeC823E1V_gEi8rSBvuMD2iJXMoTV2vRDEyBUbDOM9k-kScGlQNGSsYKVWNRHFHfOeu81W_buPk0KUkwEpULUeMy5zg3d1K3l7kBGpaRy_0nqvDRqcz1i29zJE3VfnQKFgwBOphDk-YdOYTy732myt9ibI2yF0tEm1QCnUjL4DLCcEXHLG8lwjJpMJflGCyeT8E1JyJjLwED5vXuwrLuDw=w882-h492-no',
      directions: 'Read the article about Hourglass Dolphins, then answer the questions.',
      question1: 'What is the heading of this article?',
      subQuestion1: 'How do you know?',
      question2: 'What does the caption tell you?',
      subQuestion2: '',
    ...
    bookCovers: [
      ...
      activity: {
        ...
        heading2: 'What does a caption in this section tell you?',
        heading3: 'What is something you learned just by looking at one of the pictures?',
        heading4: 'What is one cool fact you learned?',
        subheading1: 'How do you know?',
        subheading2: ''
      },
  ...
  CR26a: {
    lessonTitle: 'Sequence in an Informational Text',
    skillDescription: 'Important informational text features are headings (the title of a chapter or section), captions (text near the picture that tells you more about the picture), and pictures.',
    learn: {
      media1: 'https://www.youtube.com/embed/3mAl9QMJJTo?rel=0&amp;showinfo=0',
      media2: 'https://giphy.com/embed/l44Q9EPJIzYediXp6'
  ...
  CR27a: {
    ...
    skillDescription: 'An inference is a something you figure out using the clues in the words and pictures.',
    learn: {
      media1: 'https://www.youtube.com/embed/to30AJm2epQ?rel=0&amp;showinfo=0',
      media2: 'https://www.youtube.com/embed/rCmTlK_rb0U?rel=0&amp;showinfo=0'
    },
    practice: {
      media: 'https://giphy.com/embed/PsFhnunpPizlu',
      directions:  'Read each sentance. Then answer the question using a complete senctence',
      question1: '1. Juan opened the door to his house. All his friends were there! There was also a cake, present, and balloons.',
      subQuestion1: 'What inference can we make about what is happening in Juan\'s house?',
      question2: '2. Even though Tiana put on her hat and her scarf, she was still shivering.',
      subQuestion2: 'What inference can we make about how Tiana is feeling?',
  ...
  CR28a: {
    lessonTitle: 'Summerizing Stories',
    skillDescription: 'Summarizing a story means to retell only the most important parts by telling what happened in the beginning, middle, and end.',
    learn: {
      media1: 'https://www.youtube.com/embed/_gcC8B26IcQ?rel=0&amp;showinfo=0',
      media2: 'https://giphy.com/embed/NFA61GS9qKZ68'
    },
    practice: {
      media: 'https://giphy.com/embed/PsFhnunpPizlu',
      directions:  'Watch the video, then answer the questions. After you\'re done, go back and read your answers in order to hear your summary.',
